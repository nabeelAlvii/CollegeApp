...
public class Staff_Schedule extends AppCompatActivity implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
...
//                    Toast.makeText(Admin.this, "Email :"+mail, Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Toast.makeText(Staff_Schedule.this, "Selcted :" + selectdsched, Toast.LENGTH_SHORT).show();
    }
