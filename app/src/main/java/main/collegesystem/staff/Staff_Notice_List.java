...
public class Staff_Notice_List extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(final AdapterView<?> parent, View view, int position, long id) {
        ...
        pdetail.getFirstInBackground(new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject parseObject, ParseException e) {
                ...
                Intent i = new Intent(Staff_Notice_List.this, Staff_Notice_Detail.class);
                i.putExtra("notidob", notid);
                startActivity(i);
                Toast.makeText(Staff_Notice_List.this, "Parse :" + parseObject.getObjectId(), Toast.LENGTH_SHORT).show();
            }
        });
